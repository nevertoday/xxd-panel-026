...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 026 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 026 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 026 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 026 作例 8"></td>
  </tr>
</table>
...
**Panel 026** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真に宿る事実を、静かでやわらかく、それでもひと目で分かる幾何学へ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
## すぐに判断：XXD Panel 026 はあなたに合う？

| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 写真に宿る事実を、静かでやわらかく、それでもひと目で分かる幾何学へ |
| **ひと目で分かる特徴** | RECOGNISE QUIETLY · REDUCE GENTLY · LET THE PAPER BREATHE |
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 026 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-026 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP
...
/xxd-panel-026 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-026 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-026 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 026 を適用し、共通設定は一度だけ解決
/xxd-panel-026 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
...
- [元のスタイル説明](references/original-prompt/zh-CN.md)
